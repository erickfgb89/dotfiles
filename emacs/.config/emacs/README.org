...
*** shortcuts
    ...
    #+END_SRC
*** projectile library
    I'm removing popup-eshell because it mucks with window layout in a way that breaks ecb
    #+BEGIN_SRC emacs-lisp#
...
** UI Options
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (if (font-family-installed-p "Input Mono")
         (set-frame-font (concat "-*-Input Mono-normal-normal-"
